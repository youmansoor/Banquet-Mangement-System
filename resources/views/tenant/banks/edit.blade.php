...
<div class="container-fluid mt-4">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('tenant.banks.update', $bank) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="bank_name" class="form-control" value="{{ old('bank_name', $bank->bank_name) }}" placeholder="Enter bank name" required>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label">Opening Balance (Rs.) <span class="text-danger">*</span></label>
                        <input type="number" name="opening_balance" class="form-control" step="0.01" min="0" value="{{ old('opening_balance', $bank->opening_balance) }}" placeholder="0.00" required>
                    </div>
